...
# ╔═╡ c575e10c-b27a-4054-918d-caf202d5c1c1
using Graphs, WGLMakie, GraphMakie

# ╔═╡ 7ce47a5d-9489-48f0-ab50-892820d53e1c
using DotProductGraphs

# ╔═╡ 0b690058-8fd1-11ee-3389-f91d94a57310
using PlutoUI, PlutoTeachingTools

# ╔═╡ 7704042e-030f-481a-a421-3ee9b7f35db6
begin
	using ZipArchives: ZipBufferReader, zip_names, zip_readentry
	using Downloads: download
end

# ╔═╡ b7958040-19a8-4ced-91d2-fd565f68f19b
using Makie.Colors

# ╔═╡ 248fa122-b006-4918-8d4a-0ba294fed774
ChooseDisplayMode()

# ╔═╡ 43acea14-a455-460a-9424-cb79561ac67a
md"""
# Graphs, Networks, and Dynamical Systems
...
University of Canterbury | Baffelan | Inverence
"""

# ╔═╡ 1f289683-8466-4832-91ed-30c84b3445e4
md"""
...
- Graphs (and a demo)
- _________ Networks 
- Graphs + Networks + Dynamical Systems
"""

# ╔═╡ 2fa9410a-29d5-49ed-97fd-0b380f4bde18
md"""
# Graphs
"""

# ╔═╡ 461ac245-545b-4a06-8de1-aaa903a6109b
md"""## """

# ╔═╡ 2fc1dd7b-5f9b-413b-9521-fb4bfe23b036
md"""
## Demo
"""

# ╔═╡ 18b2650a-1db5-4f4b-88b3-82bf8bedabb9
md"""## Ecology"""

# ╔═╡ fee3f0e7-abbf-4ec1-8529-6bae3a0c7bd0
md"""## """

# ╔═╡ 68391191-4848-4afc-a60b-e269d58ca2c0
md"""## """

# ╔═╡ c0c7a8b8-9b07-4138-871e-a9e3d99415dd
md"""## Ecology by Evolution"""

# ╔═╡ 3f864404-105f-4306-ba36-93c03604b44b
md"""
## Networks
"""

# ╔═╡ 271e35fd-9fbe-412b-8f53-dbde857396bb
md"""## """

# ╔═╡ cb1ed393-6854-436f-81cd-8958be9533d8
md"""
## Graphs + Networks + Dynamical Systems
"""

# ╔═╡ c7416a3f-8d61-4618-b753-eeeb15178201
md"""## """

# ╔═╡ 5e9c8d9d-21bf-45c0-901c-4eb75c719a0d
md"""
## building stuff
"""

# ╔═╡ b6cd725d-5f6b-4d01-b57f-1358bcbb027f
import GraphIO: EdgeList

# ╔═╡ 198c2a80-67a5-46d9-8df2-63916425f73a
rs(url::String) = Resource(url, :width => 600)

# ╔═╡ 2eb12620-1404-4cf3-aa42-1ad0468cab14
snp_fw = "https://www.researchgate.net/profile/Andy-Dobson/publication/51984403/figure/fig7/AS:341375242522658@1458401608743/The-Serengeti-food-web-The-network-is-shown-organized-and-colored-by-group-according-to.png";

# ╔═╡ e4a0f9ca-a4af-4ed7-b886-7fc9bf52028d
rs(snp_fw)

# ╔═╡ 2ca398b9-f1be-46d0-a4c8-37e36f4d0008
snp_emb = "https://i.imgur.com/7cGZDTR.png";

# ╔═╡ 672296d0-617f-4fed-98c7-bcaf61fce65e
rs(snp_emb)

# ╔═╡ 1a5cb779-9bc7-4b7b-84c6-abf5fdc6eee3
n_to_col(i) = i == 1 ? colorant"deepskyblue" : colorant"maroon1"

# ╔═╡ 6c409009-6509-4c4a-8631-15852f182551
oik_head = "https://i.imgur.com/JRAzXgl.png"

# ╔═╡ f1950848-40dd-4675-91fa-cbab2aca14aa
rs(oik_head)

# ╔═╡ aca9752f-e3ce-415b-bd5e-da64eff42d3c
hyrax = "https://www.worldatlas.com/r/w1200/upload/2e/df/53/shutterstock-201373283-1.jpg"

# ╔═╡ c6948a41-0313-41ad-b0d1-c28a59019e0b
rs(hyrax)

# ╔═╡ c9ff59fd-35c2-4769-8619-3741d3990374
fi_url = "https://i.imgur.com/1N9oKTj.png"

# ╔═╡ b39fb93d-45e1-4293-951d-9947a872580c
rs(fi_url)

# ╔═╡ e8dba46a-3f7a-437f-ad61-6833a7c57d1b
ent_res = "https://www.frontiersin.org/files/Articles/623141/fevo-09-623141-HTML/image_m/fevo-09-623141-g005.jpg"

# ╔═╡ 2da0bb0e-7102-4b5e-8353-577e7b8d259e
rs(ent_res)

# ╔═╡ 69552263-080b-4b55-8fb7-306625ac4a9e
ent_int = "https://www.frontiersin.org/files/Articles/623141/fevo-09-623141-HTML/image_m/fevo-09-623141-g004.jpg"

# ╔═╡ f1be574a-be26-4d93-a194-60792c453624
rs(ent_int)

# ╔═╡ 5de9ce59-2ba7-45ba-8832-cfb2d4517e1d
ent_ot = "https://www.frontiersin.org/files/Articles/623141/fevo-09-623141-HTML/image_m/fevo-09-623141-g001.jpg"

# ╔═╡ 928bb431-2edb-4f69-8eba-19999522c66f
rs(ent_ot)

# ╔═╡ 725f3663-2ca1-4106-965e-2fb1d9642b53
tran_url = "https://i.imgur.com/v3hw4Nw.png"

# ╔═╡ a9557986-3366-4a7d-b307-f2419a097177
rs(tran_url)

# ╔═╡ 3872c336-e367-416a-8a08-babc208c271f
tran = "https://besjournals.onlinelibrary.wiley.com/cms/asset/d110c464-2093-4eee-ae0c-4d1cedf01151/mee313835-fig-0001-m.jpg"

# ╔═╡ b764969d-b213-4c70-b3b2-2bd320685238
rs(tran)

# ╔═╡ ba1ed466-103e-4adb-861a-5cd5d14fda8b
metahead = "https://i.imgur.com/fYMvbdZ.png"

# ╔═╡ 0cdb09bc-c90e-48de-a27b-242b35211a0b
rs(metahead)

# ╔═╡ 8eaac7fb-5b5d-4aa6-9588-5d60b6354d56
metadiag = "https://royalsocietypublishing.org/cms/asset/1d5d2271-cca2-4156-b76e-d857162e227c/rsos220079f01.jpg"

# ╔═╡ 48a0e305-3782-456b-83a5-6a28500f447f
Resource(metadiag, :width => 400)

# ╔═╡ 09c6e2ba-19d0-4b85-b2e5-46d0f94afa27
cont = "https://i.imgur.com/BQnmOFV.png"

# ╔═╡ a8993781-b5f1-4dfa-9205-102f3c7ce6d5
rs(cont)

# ╔═╡ 3c8d9321-76c8-44b9-8755-9f5134b7734a
rdpg_sciml = "https://i.imgur.com/OaBsiul.png"

# ╔═╡ 9834b97f-e674-48bc-9aa6-11a66b3b7f65
rs(rdpg_sciml)

# ╔═╡ 00000000-0000-0000-0000-000000000001
PLUTO_PROJECT_TOML_CONTENTS = """
[deps]
DotProductGraphs = "586abeb4-6645-4f28-8984-da840f878f37"
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "b7eaec073c388e649e64dee7a0b218cb62bf7e31"
...
[[deps.DotProductGraphs]]
deps = ["BlockArrays", "Graphs", "KrylovKit", "LinearAlgebra", "LowRankApprox", "SparseArrays"]
git-tree-sha1 = "24b2d5c217ef77318ed8a91caab01ae51f415b34"
uuid = "586abeb4-6645-4f28-8984-da840f878f37"
version = "0.1.0"
...
git-tree-sha1 = "e56a12d9aca0aad822cfc4e9b650ffabd70d235e"
...
git-tree-sha1 = "407115f532a00c058038a68afb93abe4503e5460"
