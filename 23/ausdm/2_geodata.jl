...
# ╔═╡ dc4b24cb-0744-4514-b0e3-63748b582f49
using GeoRegions, GeoStats

# ╔═╡ 05157320-6000-4d55-bd50-01d54df1c345
using IterTools
...
# ╔═╡ 78cd540c-9867-402d-9667-33ae8ca384f0
md"## Part 1: simple data"
...
md"""
°°Hello world°° -> plot something cool
"""

# ╔═╡ 7a4c8991-97d2-4779-88cb-e1da08e800c3
Makie.set_theme!(DataShader = (; async=false))

# ╔═╡ b9d59edd-5273-4d5c-b7f3-255c93516e4f
GeoRegions.tableGeoRegions()

# ╔═╡ 39c5170b-ac24-4e8b-9cc1-e6564f585a02
lsd = getLandSea(GeoRegion("AR6_NZ"),savelsd=false)

# ╔═╡ 5d4b0f30-dec4-443a-a6c4-93c3e190fbd9
grid = GLMakie.Point2f.(product(lsd.lon, lsd.lat))

# ╔═╡ 41d7e0ef-ec62-420f-9d3b-02ec36521894
grid |> vec

# ╔═╡ 32ecc8ab-ff73-4bb7-a694-0058fcb5652d
stab = (lat = lsd.lat,
	lon = lsd.lon)

# ╔═╡ 0736a072-8e9f-4f9d-b015-b8c9a46bdc56
nz_table = (
	height = lsd.z |> vec,
	is_sea = lsd.lsm |> vec
)

# ╔═╡ b15f44a5-c752-4126-b0c1-5be35ec925bd
nz_domain = PointSet(vec(grid))

# ╔═╡ e4222eb2-fd2e-4049-a397-0bde367d0321
nz_map = georef(nz_table, nz_domain)

# ╔═╡ 1be087a0-0189-434f-af07-9ca1effbe8fa


# ╔═╡ 8585de56-bfeb-4cea-9a1f-ca5662d21546
high_land = nz_map  |> Filter(row -> row.height > 2000)

# ╔═╡ 07321ffe-747e-42fb-8eac-c6485a30f677
peaks = high_land.geometry |> collect

# ╔═╡ 89f62f95-34aa-44e7-8a09-51ef07a82f12
high_land.geometry |> collect |> eltype

# ╔═╡ 82f01101-28a0-4a03-a09c-bc90c6d8e4f3
begin
	fig, ax, ds = datashader(peaks,
...
# ╔═╡ 266df2f1-3f4f-41c4-b7ef-f469bad328b0
const Point = GLMakie.Point

# ╔═╡ 5c1b347a-fb0a-42b1-9b5a-a56a30e5e1ab
# ╠═╡ disabled = true
#=╠═╡
viz(img.geometry, color = img.hslm)
  ╠═╡ =#
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "db5080dd0a845f0a75fa129fef4f0880ccc2bcac"
...
git-tree-sha1 = "33e81ca6a83110ad88f493185f58fd4cf5a5ed44"
...
[[deps.GeoRegions]]
deps = ["Dates", "DelimitedFiles", "GeometryBasics", "ImageFiltering", "Logging", "NCDatasets", "PolygonOps", "PrettyTables"]
git-tree-sha1 = "473987e8d3b404e866cfb52176ad8787b1bf60a0"
...
git-tree-sha1 = "8734d4c61177cf8bd4605ca0162615ae1defea2a"
...
git-tree-sha1 = "8b947fab4190368b2dcac7d839a7bb2c39ec82dd"
...
git-tree-sha1 = "722dcc26a354eba42f2ad697eded6352bd72c287"
...
git-tree-sha1 = "61cc8630fbf9e6460107878415e41ad611f57c73"
...
git-tree-sha1 = "c76edecefe5712d698e74479d9875a1f26bb7b5b"
...
git-tree-sha1 = "745e1948c0b785fff6d8f40b5c1d6d343456f57d"
...
git-tree-sha1 = "feb2d40c35fd99ea93319a2feb5989d484660601"
...
git-tree-sha1 = "80ef718346e28f8103c23bbe17ca0605bf7f2d9d"
...
git-tree-sha1 = "0317ca1497894dd074bbb445cdcbd2d7d1498cea"
...
[[deps.TransformsBase]]
deps = ["AbstractTrees"]
git-tree-sha1 = "0ac5281115de650e5d7902cb1fc9caa41085336a"
...
git-tree-sha1 = "763f2be379458f0014a8632a03486777fde2ee43"
